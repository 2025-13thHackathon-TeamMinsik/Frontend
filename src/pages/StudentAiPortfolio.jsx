       ...
       <S.Box1>
        ...
        /></S.Profile>
          <S.Box2> 
            ...
            <S.Box4><S.Text1>학교 | </S.Text1><S.Text2>&nbsp;동덕여자대학교</S.Text2></S.Box4>
            <S.Box4><S.Text1>전공 | </S.Text1><S.Text2>&nbsp;미디어디자인</S.Text2></S.Box4>
            <S.Box4><S.Text1>학년 | </S.Text1><S.Text2>&nbsp;휴학 중</S.Text2></S.Box4>
          </S.Box2>
       </S.Box1>
       <S.Line></S.Line>
        <S.Box5><S.Text1>연락처 | </S.Text1><S.Text2>&nbsp;010-1234-5678</S.Text2></S.Box5>
        <S.Box5><S.Text1>이메일 | </S.Text1><S.Text2>&nbsp;happyshare1234@gmail.com</S.Text2></S.Box5>
        <S.Box5><S.Text1>주소 | </S.Text1><S.Text2>&nbsp;성북구 화랑로 13길 60</S.Text2></S.Box5>
       <S.Line></S.Line>
       <S.Box6>
       <S.Union1><img
          src={`${process.env.PUBLIC_URL}/images/back3.svg`}
          alt="union" width="20.364px"
        /></S.Union1>
        ...
        <S.TextBox>200자 공백 포함. 안녕하세요. 저는 동덕여자대학교<br></br>
       ...
       <S.Union2><img
        ...
        /></S.Union2>
         ...
         <S.TextBox2>
          ...
          <S.Line2></S.Line2>
          <S.Text5>성북구 카페의 SNS 마케팅을 함께하며 촬영,운영,홍<br></br>
            보 실무를 경험하였습니다. 사장님과의 협업으로 마케<br></br>
            팅 감각과 현장 적응력을 키웠습니다. 저의 재능이 도<br></br>
