        ...
        {showRequestBox && (
          <S.Overlay onClick={() => setShowRequestBox(false)}>
            <S.RequestBox onClick={(e) => e.stopPropagation()}>
              <S.CoinIcon>
                <img
                  src={`${process.env.PUBLIC_URL}/images/CoinIcon2.svg`}
                  alt="CoinIcon"
                  width="29px"
                />
              </S.CoinIcon>
              <S.Info>재능요청이 완료되었습니다.</S.Info>
              <S.Line5 />
              <S.Ok
                onClick={() => {
                  setRequestStatus("대기 중"); // 버튼 텍스트 바꾸기
                  setShowRequestBox(false); // 모달 닫기
                }}
              >
                확인
              </S.Ok>
